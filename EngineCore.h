...
private:
    ...
    void createInstance() {
        constexpr vk::ApplicationInfo appInfo{ .pApplicationName = "Main Window",
    ...
    void createGraphicsPipeline() {
        vk::raii::ShaderModule shaderModule = createShaderModule(readFile("F:/VulkanProject/VulkanTutorial/shaders/slang.spv"));
